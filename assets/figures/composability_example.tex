...
%arrows
	...
	\uncover<4->{
		...
		\draw [<-, ultra thick] (0.75,-0.25) -- (4,-0.25) node [midway,above] {\scriptsize{mint token}};
	}
	\uncover<5->{
		\draw [<-, ultra thick] (-4,-0.25) -- (-0.75,-0.25) node [midway,above] {\scriptsize{grey basket token}};
	}
%circles
	\uncover<1->{
