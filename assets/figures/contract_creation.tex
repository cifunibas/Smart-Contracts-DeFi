...
\filldraw[fill=highlight!50,dotted,thick] (0.78,-0.7) -- (6.3,-0.7) -- (6.3,0.7) -- (0.78,0.7) -- (0.78,-0.7) node[midway, right=-0.02cm,text width=4.25cm]{\scriptsize{Edith: ``I send a transaction with Data $d$ to  address 0x00\dots ''}};
