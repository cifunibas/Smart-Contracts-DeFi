...
% Layers
	...
	\filldraw[color = mint!50, ultra thick, draw=strongmint] (0,1.75) rectangle ++(15,1.5);
	\node [right, xshift = 0.2cm, text = black] at (0,2.5) {\textbf{Asset Layer}};

	\filldraw[color = brightanthracite!50, thick, draw=black] (0,3.5) rectangle ++(15,1.5);
...
% Settlement components
	...
	\draw [fill = white, thick , draw=strongmint ] (4,0.2) rectangle  ++(3,2.85) node [midway, text width = 2.8cm, align = center ] {Native protocol asset (ETH)};
	\draw [fill = white, thick ] (7.25,0.2) rectangle  ++(7.5,1.1) node [midway, text width = 7.3cm, align = center ] {(Ethereum) Blockchain};
	
	
% Asset components
	
	\draw [fill = white, thick , draw=strongmint ] (7.25,1.95) rectangle  ++(3,1.1) node [midway, text width = 2.8cm, align = center ] {Fungible tokens: ERC-20};
	\draw [fill = white, thick , draw=strongmint ] (10.5,1.95) rectangle  ++(3,1.1) node [midway, text width = 2.8cm, align = center ] {Non-fungible tokens: ERC-721};
	\draw [fill = white, thick , draw=strongmint ] (13.75,1.95) rectangle  ++(1,1.1) node [midway, text width = 0.8cm, align = center ] {...};	
	
	
% Protocol components

	\draw [fill = white, thick ] (4, 3.7) rectangle  ++(2.2,1.1) node [midway, text width = 2cm, align = center ] {Exchange};
	\draw [fill = white, thick ] (6.45, 3.7) rectangle ++(2.15,1.1) node [midway, text width = 2cm, align = center ] {Lending};
	\draw [fill = white, thick ] (8.85, 3.7) rectangle  ++(2.2,1.1) node [midway, text width = 2cm, align = center ] {Derivatives};
	\draw [fill = white, thick ] (11.3, 3.7) rectangle  ++(2.2,1.1) node [midway, text width = 2.1cm, align = center ] {Asset Management};
	\draw [fill = white, thick ] (13.75, 3.7) rectangle  ++(1,1.1) node [midway, text width = 0.8cm, align = center ] {...};
