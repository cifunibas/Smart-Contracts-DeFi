...
% Protocol components
	...
	\draw [fill = white, thick, draw=red ] (4, 3.7) rectangle  ++(2.2,1.1) node [midway, text width = 2cm, align = center ] {Exchange};
	...
	\draw [fill = red!30, thick, draw = darkmint ] (11.3, 3.7) rectangle  ++(2.2,1.1) node [midway, text width = 2.1cm, align = center ] {Asset Management};
