\begin{tikzpicture}[]
	...
	\uncover<1,5>{
		...
		\draw[-, thick, green] (2.4,1.5996) -- (3.6,1.0664) node[midway, left, yshift=-0.3cm, xshift = 0]{\scriptsize $P'_x$};
	    \draw[fill=black] (3,1.333) circle(2pt);		
	}
	...
	\uncover<2->{
		...
		\draw[-, thick, green] (2.4,1.884) -- (3.6,1.256) node[midway, right, yshift=0.15cm]{\scriptsize $P'_{x,\rho}$};
