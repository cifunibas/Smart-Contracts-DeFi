\begin{tikzpicture}[]
			...
			% function
     		...
     		\uncover<2->{ 
      		\draw[samples = 200, color=blue, scale=1, xshift = 0cm, yshift = 0cm, domain=1.345:4.55, smooth, variable=\x] plot ({\x}, {6/\x}) node[right,color=blue] {\scriptsize{$k' = 100.0274$}} ; 
 			}
			...
			\draw[->, red] (0.1, 1.95) -- (0.1, 1.75) node [midway, right] {\scriptsize{-0.9066}};
