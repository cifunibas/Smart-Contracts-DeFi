\begin{tikzpicture}[domain=-8:8, scale=0.8]
	...
	\filldraw[draw=black,fill=white] (c1) circle (5pt) node[below=0.15cm,color=black]{\footnotesize{Alice}};
	...
	\filldraw[color=black,fill=black!20] (c5) circle (5pt) node[above=0.15cm,color=black]{\footnotesize{Brian}};
	\filldraw[color=black,fill=black!20] (c6) circle (5pt) node[right=0.15cm,color=black]{\footnotesize{Jake}};
	\filldraw[color=black,fill=black!20] (c7) circle (5pt) node[below=0.15cm,color=black]{\footnotesize{Claudia}};
	...
	\draw[shorten >=0.28cm,shorten <=0.28cm, <-] (c6) to[] (c5);
	\draw[shorten >=0.28cm,shorten <=0.28cm, <-] (c6) to[] (c7);

	\filldraw[fill=black!20,dotted,thick] (0.76,-0.7) -- (5.24,-0.7) -- (5.24,0.7) -- (0.76,0.7) -- (0.76,-0.7) node[midway, right=-0.0cm,text width=3.5cm]{\scriptsize{``I bid 3 ETH.''}};
