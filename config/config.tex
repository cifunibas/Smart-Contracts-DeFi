...
\newcommand{\globvar}[1]{\color{violet} \texttt{#1} \color{black}}
\newcommand{\typesunits}[1]{\color{teal} \texttt{#1} \color{black}}
\newcommand{\genkey}[1]{\color{blue} \texttt{#1} \color{black}}
...
\lstdefinelanguage{Solidity}{
	keywords=[1]{anonymous, assembly, assert, balance, break, call, callcode, case, catch, class, constant, continue, constructor, contract, debugger, default, delegatecall, delete, do, else, emit, event, experimental, export, external, false, finally, for, function, gas, if, implements, import, in, indexed, instanceof, interface, internal, is, length, library, max, memory, min, modifier, new, override, payable, pragma, private, protected, public, pure, push, require, return, returns, revert, selfdestruct, send, solidity, storage, struct, suicide, super, switch, then, this, throw, transfer, true, try, type, typeof, unchecked, unicode, using, value, virtual, view, while, with, addmod, ecrecover, keccak256, mulmod, ripemd160, sha256, sha3}, % generic keywords including crypto operations
