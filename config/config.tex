...
\setbeamercolor{block body}{bg=brightanthracite}
\setbeamercolor{block title}{bg=anthracite, fg=white}
\setbeamerfont{block title}{size = \footnotesize}
\setbeamerfont{block body}{size = \scriptsize}

\setbeamercolor{block body example}{bg=mint}
\setbeamercolor{block title example}{bg=darkmint, fg=white}
