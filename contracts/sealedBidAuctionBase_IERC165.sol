...
import "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/release-v4.7/contracts/utils/introspection/IERC165.sol";
...
contract SealedBidAuction is IERC165, ISealedBidAuction {
  ...
  function supportsInterface(bytes4 interfaceID) external pure returns (bool) {
    return
        ...
        interfaceID == type(ISealedBidAuction).interfaceId; // Auction Interface
  }
