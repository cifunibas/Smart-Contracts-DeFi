...
\draw [thick] ( -3 , -0.5) rectangle (2.2 ,0.5);
\draw [thick] ( 2.2 , -0.5) rectangle (3 ,0.5);


\node [align=center] at (-0,0){99$\%$};
\node [align=center] at (-0,-1){Alice};


\node [align=center] at (2.6,0){1$\%$};
\node [align=center] at (2.6,-1){Bob};
}
...
\node at (8,0){no F-NFT redemption};
...
\end{tikzpicture}
		...
		\hspace{1 em}
		\begin{minipage}{0.72\textwidth}
		Predefined terms such as: time, auction type etc.
		\end{minipage}
		\pause
		\vspace{1 em}		
