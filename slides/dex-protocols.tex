...
\begin{frame}{Concentrated Liquidity}
	\begin{figure}[h!]
		...
		\end{center}
		\only<1>{\caption*{Liquidity provision on full price range}}
		\only<2>{\caption*{Concentrated liquidity position on range $[P_a, P_b]$}}
		\only<3>{\caption*{Aggregated concentrated liquidity positions}}
	\end{figure}	
\end{frame}
%%%
