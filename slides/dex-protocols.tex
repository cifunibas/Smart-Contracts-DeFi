...
\begin{frame}{Slippage (with fees)}
	...
	\begin{minipage}{0.4\textwidth}
		...
		\begin{scriptsize}
			...
			\only<5->{
				\intertext{ \textbf{Total Slippage:} \vspace{-0.3cm}}
...
\begin{frame}<beamer:0>{Swap Example: Prices and Slippage}
	\begin{align*}
		...
		S_{price} &= \tfrac{0.6667}{1} - 1 = -0.3333\\[0.1cm]
		S_\rho &= \tfrac{0.5714}{0.6667} - 1 = -0.1429\\[0.1cm]
		S &= \tfrac{0.5714}{1} - 1 = -0.4286\\[0.1cm]
 	\end{align*}
\end{frame}
