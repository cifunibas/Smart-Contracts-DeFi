  ...
  \only<2>{
		...
		\begin{minipage}[c]{0.5\textwidth}
			\begin{itemize}
				...
				\item The offering party can create a pool with its token and a small amount of ETH.
				\item This mechanism is useful for price discovery of a new asset. \link \href{https://unisocks.exchange/}{Uni\$ocks}
			\end{itemize}
		\end{minipage}
	\end{figure}
