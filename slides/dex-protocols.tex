...
\begin{frame}{Swap (without fees)}
	\vspace{0.5cm}
	% TODO: Überschriften für die 3 Formeln einfügen
		\begin{align*}
...
\begin{frame}{Concentrated Liquidity}
	...
	\begin{figure}[h!]
		...
		\only<3>{\caption*{Aggregated concentrated liquidity positions\footnote{\href{https://uniswap.org/whitepaper-v3.pdf}{Uniswap V3 Whitepaper \link}}}}
	\end{figure}	
\end{frame}
%%%
...
\begin{minipage}[c]{0.45\textwidth}
	\begin{itemize}
		\item CFMMs can also be used for initial token offerings.
		\item Example: The offering party can create a pool with its token and a small amount of ETH.
	\end{itemize}
\end{minipage}
