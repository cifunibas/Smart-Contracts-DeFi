...
\begin{frame}{Swap (with fees 2)}
	\begin{figure}[h!]
		\begin{center}
			\input{../assets/figures/constant_product_swap_with_fees_Kopie.tex}
		\end{center}
	\end{figure}
\end{frame}
%%%
...
\only<5>{Slippage $S$ is the deviation from the price for a indefinitesimal trade $P_x$ to the price for an actual trade $P_{x,swap}$.}
\end{frame}
%%%
