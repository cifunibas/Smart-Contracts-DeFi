...
\textbf{Special modifiers for functions:}
	\begin{itemize}
		...
		\item<2-> \genkey{virtual} \& \genkey{override}: used for inheritance (\textcolor{focus}{more on this later!}).
...
\begin{frame}{Immutable \texttt{beneficiary}}
	...
	\begin{exercise}{Exercise:}
		\begin{enumerate}
			\item Remove \genkey{function} \texttt{initialize(}\typesunits{address}\texttt{\_beneficiary)} \genkey{external} \texttt{\{...\}} from our auction contract.
