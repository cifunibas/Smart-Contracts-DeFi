...
\vspace{0.5em}
\uncover<2->{
This lecture only touches some key aspects of the topic. For application in your own projects, consult detailed documentations and the numerous examples.
}
