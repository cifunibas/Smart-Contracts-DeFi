...
Solidity offers various constructs to modularize code and reduce complexity during development.\\
...
\link \href{https://docs.soliditylang.org/en/latest/contracts\#libraries.html}{Solidity documentation on libraries}.
}
