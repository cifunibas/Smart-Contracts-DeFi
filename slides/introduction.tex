...
\begin{frame}{Interdisciplinary Approach}
	...
	\vspace{1em}
Public Blockchains can only be fully understood when studied from various perspectives. This is why this course takes an \color{focus} \textbf{interdisciplinary} \color{black} approach.	
