...
\begin{enumerate}
	\item<1-> \textbf{Blockchain Fundamentals}\\
		Recap of fundamental aspects of blockchain networks and their mechanics.
		\vspace{0.2em}
	\item<2-> \textbf{Ethereum Basics}\\
		The specifics of Ethereum as Smart Contract platform.
		\vspace{0.2em}
	...
	\item<4-> \textbf{Tokenization}\\
		Motivation behind Tokenization and overview of main standards on Ethereum.
		\vspace{0.2em}
	...
	\begin{columns}[T]
		...
		\begin{column}{0.31\textwidth}
			...
			\begin{table}\small
				\begin{tabular}{c}
					Tobias Bitterli\\
					\href{https://linkedin.com/in/WIP/}{\faLinkedinSquare}\ \href{https://twitter.com/WIP}{\faTwitterSquare}\\
					\vspace{0.5em}\\
					Mitchell Goldberg\\
...
\uncover<1->{
	...
	\begin{itemize}
		...
		\item Groups of XX-XX students.
		\item Presentation and discussion on December 3, 2021.
	\end{itemize}
}
