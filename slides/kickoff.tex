...
The topic is in great demand and will help you to fast track your professional finance career. That being said, there will be \color{focus} some hiccups and moving parts... \color{black} \vspace{1em} 
	\begin{itemize}
		\item Ropsten $\rightarrow$ Goerli.
		\item Potentially frontend changes for the tools we are using. 
		\item New consensus protocol and switch to EIP-1559.
	\end{itemize}	
	
	\vspace{2em}
	
	Our \color{focus} focus is on extensions and new topics \color{black}! Any \color{focus} changes will be implemented as quick fixes\color{black}. If you have any questions, have found a bug or want to support the open lectures project, feel free to approach us at any time. 
...
\uncover<1->{
\textbf{Kickoff Event}\\
18th September 2022, 2:15pm - 4pm
\begin{itemize}
...
18th November 2022, 23:59:59.
\begin{itemize}
	\item Submission: \url{katrin.schuler@unibas.ch}
\end{itemize}
} 
\vspace{0.5em}

\uncover<4->{
\textbf{Seminar Day (Group Presentations)}\\
24th November 2022, 8:15am - 6:00pm
\begin{itemize}
	\item Presentation of group projects.
	\item<5-> Yes, there will be a \color{focus}\textbf{WORLD CUP BREAK}\color{black}! \\ (Switzerland v. Cameroon, 11am - approx. 1pm)
\end{itemize}
}
\vspace{0.5em}
...
\uncover<6->{
\textbf{Exam}\\
Date tbd, will soon be available in course directory.
}
\end{frame}
%%%
...
\label{TEAM}
	Talk to your colleagues and try to form groups - ideally 3-4 team members. Submit your group by sending an email to 	katrin.schuler@unibas.ch. The email must contain:
	\begin{itemize}
...
\begin{itemize}
	...
	\item<5-> Any mergers are \color{focus} s.t. the approval \color{black} of all involved parties and the professor. 
\end{itemize}
\end{frame}
%%%
