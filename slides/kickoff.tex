...
\begin{itemize}
	\item Submission: \url{mitchell.goldberg@unibas.ch}
\end{itemize}
} 
\vspace{0.5em}
...
\label{TEAM}
	Talk to your colleagues and try to form groups - ideally 3-4 team members. Submit your group by sending an email to 	mitchell.goldberg@unibas.ch. The email must contain:
	\begin{itemize}
...
\begin{itemize}
	...
	\item<5-> Any mergers and forks are \color{focus} s.t. the approval \color{black} of all involved parties and the professor. 
\end{itemize}
\end{frame}
%%%
...
\begin{itemize}
	\item<1-> Feel free to approach me in case of questions. To make sure that you will receive a prompt reply, use the email subject line "question unibas" (special high priority inbox). \\ $\rightarrow$ \url{f.schaer@unibas.ch}
	\item<2-> For general questions regarding the course and very swift responses, you can send an email to the TAs \\$\rightarrow$ \url{mitchell.goldberg@unibas.ch}
	...
	$\rightarrow$ \url{dario.thuerkauf@unibas.ch}.  
\end{itemize}
\end{frame}
%%%
