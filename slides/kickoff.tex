...
\begin{itemize}
	\item Submission: \href{mailto:dario.thuerkauf@unibas.ch?subject=Short\%20Paper\%20and\%20Slides}{\texttt{dario.thuerkauf@unibas.ch}}
\end{itemize}
} 
\vspace{0.5em}
...
\small
	...
	$\rightarrow$ \url{f.schaer@unibas.ch} (cc: \url{dario.thuerkauf@unibas.ch})
\end{frame}
...
\begin{itemize}
	...
	\item<2-> For general questions regarding the course and very swift responses, you can send an email to the TA. \\$\rightarrow$ \href{mailto:dario.thuerkauf@unibas.ch?subject=question\%20unibas}{\texttt{dario.thuerkauf@unibas.ch}}
	...
	$\rightarrow$ \href{mailto:dario.thuerkauf@unibas.ch?subject=Sepolia\%20ETH}{\texttt{dario.thuerkauf@unibas.ch}}.
\end{itemize}
\end{frame}
%%%
