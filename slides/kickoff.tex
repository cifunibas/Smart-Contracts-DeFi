...
4. December 2026, 8:00am - 9:00am
}
\vspace{0.5em}

\uncover<5->{
\textbf{Group Presentations}\\
11. December 2026, 8:15am - 6:00pm
}
\vspace{0.5em}
...
\label{EXPECTATIONS}
	\begin{itemize}
		...
		\item<8-> Presentation $\leq$ 12 minutes, followed by 5-10 minutes Q\&A
	\end{itemize}
\end{frame}
%%%
...
\scriptsize{ \textit{Please note that late submissions will incur a 0.5 grade point deduction for delays of up to 30 minutes, a 1.0 grade point deduction for delays of 31–60 minutes, and an additional 0.5 grade point deduction for each subsequent 30-minute interval. Submissions subject to deductions that would reduce the grade below 1.0 will result in disqualification from the course.}}
