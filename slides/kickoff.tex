...
The topic is in great demand and will help you to fast track your professional finance career. That being said, there will be \color{focus} some hiccups and moving parts... \color{black} \vspace{1em} 
	\begin{itemize}
		\item Ropsten $\rightarrow$ Goerli, now $\rightarrow$ Sepolia).
...
\uncover<3->{
\textbf{Short Paper, Code \& Slide Submission Deadline}\\
21st November 2025, 23:59:59.
\begin{itemize}
	\item Submission: \href{mailto:mitchell.goldberg@unibas.ch?subject=Short\%20Paper\%20and\%20Slides}{\texttt{dario.thuerkauf@unibas.ch}}
\end{itemize}
} 
\vspace{0.5em}
...
\label{TEAM}
	Talk to your colleagues and try to form groups - ideally 3-4 team members. Submit your group by sending an email to \href{mailto:dario.thuerkauf@unibas.ch?subject=Group\%20SCDF}{\texttt{dario.thuerkauf@unibas.ch}}. The email must contain:
	\begin{itemize}
...
\begin{itemize}
	...
	\item<2-> For general questions regarding the course and very swift responses, you can send an email to the TA. \\$\rightarrow$ \href{mailto:dario.thuerkauf@unibas.ch?subject=question\%20unibas}{\texttt{mitchell.goldberg@unibas.ch}}
