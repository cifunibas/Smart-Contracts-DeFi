...
\begin{minipage}{0.38\textwidth}
	...
	\uncover<2->{
	If collateral value relative to the debt falls below $aLT$, the risk of borrower default is too high, i.e., the position state is \emph{unhealthy}.
	}
...
\begin{frame}{Flash Minting}
	...
	\begin{itemize}
		\item This loosens the liquidity constraint $x \leq LP_x$. 
