...
\begin{itemize}
	...
	\item \link \href{https://api.cryptokitties.co/kitties/2252}{JSON} and image centralized on Dapper Labs website.
	\item Dapper Labs can easily change or even delete the JSON file or the image.
\end{itemize}
\vspace{1em}
\begin{figure}
	\centering
	\includegraphics[scale=0.2]{../assets/images/cryptokitty.png}
	\caption*{Source: \link \href{https://img.cn.cryptokitties.co/0x06012c8cf97bead5deae237070f9587f8e7a266d/2252.svg} {Dapper Labs}}	
\end{figure}
\end{frame}
%%%
