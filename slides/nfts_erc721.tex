...
\begin{itemize}
	\item \texttt{ownerOf():} {Get the owner address of a specific token.}
	\item \texttt{setApprovalForAll():} {Set or revoke the approval for \textbf{all} of your tokens in the smart contract (collection).}
	\item \texttt{getApproved():} {Get approved address of a specific token.}	
\end{itemize}
...
%%%
\begin{frame}{Metadata JSON Schema Example} %Placeholder
%%
\end{frame}
%%%
...
\begin{frame}{NFT Exercise} %Placeholder
	...
	\begin{exercise}{Exercise 1}
		\begin{enumerate}
			\item Apply the learnings from this session and develop your own token contract. Make use of OpenZeppelin’s ERC721 reference implementation and adjust x, y, z..
			...
			\item Mint one of our Hasoshis on testnet. Can you get the rare gold version?
		\end{enumerate}
	\end{exercise}
