...
\uncover<3->{
\begin{keytakeaway}{Goal of This Lecture}
...
\uncover<2->{
\begin{keytakeaway}{Recommendation}
...
\uncover <5->{
	\begin{keytakeaway}{Further Information}
	See \href{https://www.youtube.com/watch?v=9iP_pE0cVU4}{\link Alternative Consensus Protocols - Bitcoin, Blockchain and Cryptoassets}
	\end{keytakeaway}
}
\end{frame}
%%%
