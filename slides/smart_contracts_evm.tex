...
\uncover<1->{
	\begin{figure}[htp]
    		...
    		\includegraphics[scale= 0.4]{
    			../assets/images/buterin15_tree_structure.jpg
    		}
      	\caption{
      		{\tiny Ethereum Tree Structuce, 
      		}
      		\cite{
      			merkleTree
      			}
...
\includegraphics[scale= 0.5]{../assets/images/modified_merkle_patricia_state_tree.jpg}
      \caption{{\tiny Source: \url{https://ethereum.stackexchange.com/questions/268/ethereum-block-architecture}}}\label{fig:2}
\end{figure}
...
\vspace{1em}
\begin{itemize}
	\item<1-> Equivalent of Bitcoin’s orphan blocks
	\item<2-> Short block time $\rightarrow $ higher orphan rate
\end{itemize}
\uncover<3->{Uncle = Valid orphan Block \& parent max. 6 blocks from present}
\begin{itemize}
	\item<4-> Allowing Uncle inclusion...
		\begin{itemize}
