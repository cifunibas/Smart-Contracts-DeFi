...
\begin{keytakeaway}{A Slow State Machine}
...
\begin{minipage}{0.15\textwidth}
	...
	\vspace{2em}
	\fontsize{8}{10}
		\uncover<1->{\textbf{On the negative side}}
		\begin{itemize}
			\item<1-> EVM is slow
		...
		\end{itemize}
		\vspace{1em}
		\uncover<2->{\textbf{On the positive side:}}
		\begin{itemize}
...
\vspace{2em}	
	...
	\begin{keytakeaway}{EVM Properties and Smart Contracts}
				As such, the EVM is an ideal execution environment for smart contracts.
\end{keytakeaway}				
...
\begin{minipage}{0.15\textwidth}
		...
		\includegraphics[width=1.6cm]{../assets/images/smart_contract.png}
    ...
    \hfill
	\begin{minipage}{0.7\textwidth}
	\begin{samplecode}{Shared Storage Contract (Pseudo Code):}
...
\textbf{Data (optional):} store() function w/ \\  parameter 133
\end{tiny}
	\end{minipage}
...
\begin{center}
		...
		\begin{minipage}{0.65\textwidth}
\begin{scriptsize}
\uncover<1->{\textbf{Static Off-Chain Data}}
		\begin{itemize}
			\item<1-> No native on-chain representation
			\item<1-> Data can be hashed
			\item<1-> Requires trustworthy data interfaces (oracles)
		\end{itemize}
\end{scriptsize}					
		\end{minipage}
...
\begin{tiny}
		...
		\begin{minipage}{0.65\textwidth}
\begin{scriptsize}
\uncover<1->{\textbf{Dynamic Off-Chain Data}}
		\begin{itemize}
			\item<1-> No native on-chain representation
			\item<1-> Data cannot be hashed
			\item<1-> Requires trustworthy data interfaces (oracles) as well as reliable cryptoanchors.
		\end{itemize}
\end{scriptsize}					
		\end{minipage}
